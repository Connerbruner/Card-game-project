public class Main {
    ...
    public static void tutorial() {
        ...
        while ((int)GameBoard.choice("What would you like to use? ", new Object[]{0,1,2,3} )<2);
        ...
        while (!((int)GameBoard.choice("What would you like to use? ", new Object[]{0,1,2,3} ) ==0));
        GameBoard.setChoices(new int[] {0});
        GameBoard.choice("Who would you like to attack",new Object[]{1});
